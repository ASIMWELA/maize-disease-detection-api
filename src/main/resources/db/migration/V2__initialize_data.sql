...
INSERT
    INTO users_table(id, uuid, fist_name, last_name, email, password, is_active)
    VALUES  (1, 'LtyHjn78YXSo', 'Augustine', 'Simwela', 'auga@gmail.com', '$2a$12$6BfR91PJRbgTOHQ0lg8KP.Epkx0j.8c5SUoUZFSfzu55p8we/nXCK', true),
            (2, 'LtyHjn00YXSo', 'Nelson', 'Simwela', 'nel@gmail.com', '$2a$12$6BfR91PJRbgTOHQ0lg8KP.Epkx0j.8c5SUoUZFSfzu55p8we/nXCK', true),
            (3, 'LtyHjn67YXSo', 'Salome', 'Simwela', 'salo@gmail.com', '$2a$12$6BfR91PJRbgTOHQ0lg8KP.Epkx0j.8c5SUoUZFSfzu55p8we/nXCK', true),
            (4, 'LtyHjnrtYXSo', 'Victoria', 'Simwela', 'vic@gmail.com', '$2a$12$6BfR91PJRbgTOHQ0lg8KP.Epkx0j.8c5SUoUZFSfzu55p8we/nXCK', true),
            (5, 'LtyHjvgyYXSo', 'Francis', 'Simwela', 'fra@gmail.com', '$2a$12$6BfR91PJRbgTOHQ0lg8KP.Epkx0j.8c5SUoUZFSfzu55p8we/nXCK', true),
            (6, 'LtyHjvgyYXKL', 'Abraham', 'Simwela', 'ab@gmail.com', '$2a$12$6BfR91PJRbgTOHQ0lg8KP.Epkx0j.8c5SUoUZFSfzu55p8we/nXCK', true);
INSERT
    INTO user_roles_table(role_id, user_id)
    VALUES  (1,1),
            (2,2),
            (2,3),
            (2,4),
